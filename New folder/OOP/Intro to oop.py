...
myData.SetID(input("Enter Student ID: "))
myData.SetName(input("Enter Student Name: "))
myData.SetAge(int(input("Enter Age: ")))
myData.SetGender(input("Enter Gender: "))
myData.SetSubjects(int(input("Enter 1st Subject: ")), int(input("Enter 2nd Subject: ")), int(input("Enter 3rd Subject: ")))        
myData.GetDetails()